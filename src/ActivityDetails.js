            ...
            <div class="header-custom-name">
                ...
                <div class="card text-center custom-card-activity">
                    ...
                    <div class="card-body justify-content-center custom-card-body">
                        ...
                        {this.props.myNewActivityDetails.progress.length > 0 && (this.props.myNewActivityDetails.progress[0].status !== "completed" ) && 
                                               <div  className = "marks-speedometer">
                                                    <ReactSpeedometer
                                               
                                                maxValue={this.props.myNewActivityDetails.progress[0].maxScore}
                                                value={this.props.myNewActivityDetails.progress[0].score}
                                                needleColor="rgb(80,80,80)"
                                                startColor="#edade7"
                                                segments={10}
                                                endColor="#adc1ed"
